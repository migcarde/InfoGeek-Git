...
namespace InfoGeek.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, Folders = _actorCreator.CreateFolders() };
                ...
                if (result.Succeeded)
                {
                    ...
                    await _actorCreator.CreateUserAsync(user);
        ...
        [HttpGet]
        [AllowAnonymous]
        public IActionResult RegisterSponsor(string returnUrl = null)
        {
            ViewData["ReturnUrl"] = returnUrl;
            return View();
        }
